...
extension NetworkToolProtocol{
    ...
    ///kyj videos
    static func loadKYJVideos(page:NSInteger ,completionHandler: @escaping (_ videos: [InfoItem]) -> ()) {
        //https://www.dnfzhushou3.cn/api/public/?service=Video.getRecommendVideos&uid=-9999&type=0&isstart=1&p=1
        let url = "https://www.dnfzhushou3.cn/api/public/?service=Video.getRecommendVideos&uid=-9999&type=0&isstart=1&p=" + "\(page)"
